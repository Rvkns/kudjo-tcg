      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="mb-8">
          <h1 className="text-2xl font-light text-white mb-1">
            Crea Nuova <span className="text-cyan-400 font-semibold">Carta Kudjo TCG</span>
          </h1>
          <p className="text-neutral-500 text-sm">Inserisci tutti i dettagli della nuova carta che sarà disponibile nei pacchetti e nella collezione.</p>
        </div>
          ...
          <div className="lg:col-span-2 bg-white/[0.02] border border-white/5 rounded-xl p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Lascia vuoto per il path predefinito (/cards/kj_056.png) o inserisci URL"
                className="w-full bg-[#111] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-cyan-500/50"
              />
            </div>
            ...
            <div className="pt-4 flex items-center justify-end gap-3 border-t border-white/5">
              ...
              >
                {saving ? 'Creazione...' : 'Crea Carta TCG'}
              </button>
            </div>
          </div>
